...
public class CreateNotice extends AppCompatActivity {
                    ...
                    PostCountRef.runTransaction(new Transaction.Handler() {
                        ...
                        public void onComplete(DatabaseError databaseError, boolean committed, DataSnapshot dataSnapshot) {
                            if (databaseError != null) {
                                ...
                                FirebaseDatabase.getInstance().getReference("Notice/" + busName + "/Posts").child(String.valueOf(updatedValue)).setValue(post);
                                update();
    ...
    private void showToast(String message) {
        Toast.makeText(CreateNotice.this, message, Toast.LENGTH_SHORT).show();
    }
